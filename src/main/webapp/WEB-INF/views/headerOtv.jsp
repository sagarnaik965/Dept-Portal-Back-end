			...
			<div class="container-fluid">
				<div class="navbar-header pull-left">
					...
					<a class="navbar-brand ep-logo"
						href="https://advservice.epramaan.gov.in/"> <!-- <img src="images/logo82.png" /> 
					...
					<a class="navbar-brand ministry" id="goitext"
						style="font-size: 20px; font-weight: bold; font-family: sans-serif; padding-top: 7px; margin-top: 19px; padding-left: 18px;">
						Aadhaar Data Vault </a>
				...
				<div class="pull-right">
					<a class="navbar-brand ministry" id="goitext"
						...
						Ministry of Electronics & Information Technology <small
						style="text-align: right; font-size: 17px; font-family: sans-serif; padding-top: 0px; font-weight: lighter;">
							Government of India</small>
					</a> <a class="navbar-brand goi-logo ministry"
						href="https://www.meity.gov.in/"> <img
